...
import { Store, FolderTree, Package, PackageOpen, LogOut, ExternalLink } from "lucide-react";
            ...
            {TABS.map((t) => {
              ...
              return (
                <button
                  ...
                  onClick={() => setTab(t.id)}
                  className={`h-11 px-4 text-sm font-bold flex items-center gap-2 border-b-2 transition-colors whitespace-nowrap ${
                    active
